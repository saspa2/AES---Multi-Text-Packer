...
### نحوهٔ استفاده (خلاصه)
1. هر ردیف = یک متن + یک کلید  
2. روی «تولید بستهٔ رمزنگاری‌شده» کلیک کن → یک رشتهٔ Base64 تحویل می‌دهد  
3. رشتهٔ بسته را نگه‌داری یا ارسال کن  
4. برای بازیابی متن، همان بسته را وارد کن و کلید مدنظر را بزن  
5. فقط متن مربوط به آن کلید نمایش داده می‌شود
